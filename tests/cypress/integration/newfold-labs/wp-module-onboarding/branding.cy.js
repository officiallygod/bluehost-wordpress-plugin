...
describe('Branding', function () {
    before(() => {
        ...
        cy.setCustomerData();
        cy.visit('wp-admin/index.php?page=nfd-onboarding&flow=ecommerce').wait(
            2000
        );
        // cy.injectAxe()
    });
    ...
    it('Has Bluehost branding', () => {
        ...
        cy.get('@navToggle')
            ...
            .then(($el) => {
                ...
                expect(win.getComputedStyle(el).backgroundImage).to.equal(
        ...
        // Ensure that the subheading is blue and shows the text "Bluehost"
        cy.findByRole('heading', { name: 'with WordPress and Bluehost.' })
            .should('be.visible')
